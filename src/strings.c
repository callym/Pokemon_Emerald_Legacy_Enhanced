...
const u8 gText_MainMenuOptionGameAndVersion[] = _("OPTION - LEGACY CALHANCED - Ver 1.1.4");
...
const u8 gText_MainMenuGameAndVersion[] = _("EMERALD LEGACY CALHANCED - Ver 1.1.4");
...
const u8 gText_ChoosePokemonSelectToMove[] = _("Choose a POKéMON."); // Added text to note Select can move a Pokemon, removed from Daycare flags to use for Sel instead
...
const u8 gText_50CoinsAndPrice[] = _  ("50 COINS{CLEAR_TO 0x48}¥1,000");
const u8 gText_500CoinsAndPrice[] = _ ("500 COINS{CLEAR_TO 0x48}¥10,000");
const u8 gText_1000CoinsAndPrice[] = _("1000 COINS{CLEAR_TO 0x48}¥20,000");
const u8 gText_2500CoinsAndPrice[] = _("2500 COINS{CLEAR_TO 0x48}¥50,000");
const u8 gText_5000CoinsAndPrice[] = _("5000 COINS{CLEAR_TO 0x48}¥100,000");
...
const u8 gText_KissPosterCost[] = _("KISS POSTER{CLEAR_TO 0x5E}8BP");
const u8 gText_KissCushionCost[] = _("KISS CUSHION{CLEAR_TO 0x5E}8BP");
const u8 gText_SmoochumDollCost[] = _("SMOOCHUM DOLL{CLEAR_TO 0x5E}16BP");
const u8 gText_TogepiDollCost[] = _("TOGEPI DOLL{CLEAR_TO 0x5E}16BP");
const u8 gText_MeowthDollCost[] = _("MEOWTH DOLL{CLEAR_TO 0x5E}16BP");
const u8 gText_ClefairyDollCost[] = _("CLEFAIRY DOLL{CLEAR_TO 0x5E}16BP");
const u8 gText_DittoDollCost[] = _("DITTO DOLL{CLEAR_TO 0x5E}16BP");
const u8 gText_CyndaquilDollCost[] = _("CYNDAQUIL DOLL{CLEAR_TO 0x5E}20BP");
const u8 gText_ChikoritaDollCost[] = _("CHIKORITA DOLL{CLEAR_TO 0x5E}20BP");
const u8 gText_TotodileDollCost[] = _("TOTODILE DOLL{CLEAR_TO 0x5E}20BP");
const u8 gText_LaprasDollCost[] = _("LAPRAS DOLL{CLEAR_TO 0x5E}40BP");
const u8 gText_SnorlaxDollCost[] = _("SNORLAX DOLL{CLEAR_TO 0x5E}40BP");
const u8 gText_VenusaurDollCost[] = _("VENUSAUR DOLL{CLEAR_TO 0x5E}50BP");
const u8 gText_CharizardDollCost[] = _("CHARIZARD DOLL{CLEAR_TO 0x5E}50BP");
const u8 gText_BlastoiseDollCost[] = _("BLASTOISE DOLL{CLEAR_TO 0x5E}50BP");
const u8 gText_ProteinCost[] = _("PROTEIN{CLEAR_TO 0x64}1BP");
const u8 gText_CalciumCost[] = _("CALCIUM{CLEAR_TO 0x64}1BP");
const u8 gText_IronCost[] = _("IRON{CLEAR_TO 0x64}1BP");
const u8 gText_ZincCost[] = _("ZINC{CLEAR_TO 0x64}1BP");
const u8 gText_CarbosCost[] = _("CARBOS{CLEAR_TO 0x64}1BP");
const u8 gText_HpUpCost[] = _("HP UP{CLEAR_TO 0x64}1BP");
const u8 gText_RareCandyCost[] = _("RARE CANDY{CLEAR_TO 0x64}1BP");
const u8 gText_AbilityCapsuleCost[] = _("ABILITY CAPSULE{CLEAR_TO 0x64}4BP");
const u8 gText_LeftoversCost[] = _("LEFTOVERS{CLEAR_TO 0x5E}12BP");
const u8 gText_WhiteHerbCost[] = _("WHITE HERB{CLEAR_TO 0x5E}12BP");
const u8 gText_QuickClawCost[] = _("QUICK CLAW{CLEAR_TO 0x5E}12BP");
const u8 gText_MentalHerbCost[] = _("MENTAL HERB{CLEAR_TO 0x5E}12BP");
const u8 gText_BrightPowderCost[] = _("BRIGHTPOWDER{CLEAR_TO 0x5E}16BP");
const u8 gText_ChoiceBandCost[] = _("CHOICE BAND{CLEAR_TO 0x5E}16BP");
const u8 gText_KingsRockCost[] = _("KING'S ROCK{CLEAR_TO 0x5E}16BP");
const u8 gText_FocusBandCost[] = _("FOCUS BAND{CLEAR_TO 0x5E}16BP");
const u8 gText_ScopeLensCost[] = _("SCOPE LENS{CLEAR_TO 0x5E}16BP");
const u8 gText_MetalCoatCost[] = _("METAL COAT{CLEAR_TO 0x5E}16BP");
const u8 gText_AmuletCoinCost[] = _("AMULET COIN{CLEAR_TO 0x5E}16BP");
const u8 gText_ExpShareCost[] = _("EXP. SHARE{CLEAR_TO 0x5E}16BP");
const u8 gText_LuckyEggCost[] = _("LUCKY EGG{CLEAR_TO 0x5E}16BP");
const u8 gText_MachoBraceCost[] = _("MACHO BRACE{CLEAR_TO 0x5E}16BP");
const u8 gText_CleanseTagCost[] = _("CLEANSE TAG{CLEAR_TO 0x5E}16BP");
const u8 gText_SmokeBallCost[] = _("SMOKE BALL{CLEAR_TO 0x5E}16BP");
const u8 gText_SootheBellCost[] = _("SOOTHE BELL{CLEAR_TO 0x5E}16BP");
const u8 gText_EverstoneCost[] = _("EVERSTONE{CLEAR_TO 0x5E}16BP");
const u8 gText_LiechiCost[] = _("LIECHI BERRY{CLEAR_TO 0x5E}12BP");
const u8 gText_GanlonCost[] = _("GANLON BERRY{CLEAR_TO 0x5E}12BP");
const u8 gText_SalacCost[] = _("SALAC BERRY{CLEAR_TO 0x5E}12BP");
const u8 gText_PetayaCost[] = _("PETAYA BERRY{CLEAR_TO 0x5E}12BP");
const u8 gText_ApicotCost[] = _("APICOT BERRY{CLEAR_TO 0x5E}12BP");
const u8 gText_PomegCost[] = _("POMEG BERRY{CLEAR_TO 0x5E}3BP");
const u8 gText_KelpsyCost[] = _("KELPSY BERRY{CLEAR_TO 0x5E}3BP");
const u8 gText_QualotCost[] = _("QUALOT BERRY{CLEAR_TO 0x5E}3BP");
const u8 gText_HondewCost[] = _("HONDEW BERRY{CLEAR_TO 0x5E}3BP");
const u8 gText_GrepaCost[] = _("GREPA BERRY{CLEAR_TO 0x5E}3BP");
const u8 gText_TamatoCost[] = _("TAMATO BERRY{CLEAR_TO 0x5E}3BP");
const u8 gText_SoftboiledCost[] = _("SOFTBOILED{CLEAR_TO 0x4E}4BP");
const u8 gText_SeismicTossCost[] = _("SEISMIC TOSS{CLEAR_TO 0x4E}6BP");
const u8 gText_DreamEaterCost[] = _("DREAM EATER{CLEAR_TO 0x4E}6BP");
const u8 gText_MegaPunchCost[] = _("MEGA PUNCH{CLEAR_TO 0x4E}6BP");
const u8 gText_MegaKickCost[] = _("MEGA KICK{CLEAR_TO 0x4E}12BP");
const u8 gText_BodySlamCost[] = _("BODY SLAM{CLEAR_TO 0x4E}12BP");
const u8 gText_RockSlideCost[] = _("ROCK SLIDE{CLEAR_TO 0x4E}12BP");
const u8 gText_CounterCost[] = _("COUNTER{CLEAR_TO 0x4E}12BP");
const u8 gText_ThunderWaveCost[] = _("THUNDER WAVE{CLEAR_TO 0x4E}12BP");
const u8 gText_SwordsDanceCost[] = _("SWORDS DANCE{CLEAR_TO 0x4E}12BP");
const u8 gText_DefenseCurlCost[] = _("DEFENSE CURL{CLEAR_TO 0x4E}4BP");
const u8 gText_SnoreCost[] = _("SNORE{CLEAR_TO 0x4E}6BP");
const u8 gText_MudSlapCost[] = _("MUD-SLAP{CLEAR_TO 0x4E}6BP");
const u8 gText_SwiftCost[] = _("SWIFT{CLEAR_TO 0x4E}6BP");
const u8 gText_IcyWindCost[] = _("ICY WIND{CLEAR_TO 0x4E}6BP");
const u8 gText_EndureCost[] = _("ENDURE{CLEAR_TO 0x4E}12BP");
const u8 gText_PsychUpCost[] = _("PSYCH UP{CLEAR_TO 0x4E}12BP");
const u8 gText_IcePunchCost[] = _("ICE PUNCH{CLEAR_TO 0x4E}12BP");
const u8 gText_ThunderPunchCost[] = _("THUNDERPUNCH{CLEAR_TO 0x4E}12BP");
const u8 gText_FirePunchCost[] = _("FIRE PUNCH{CLEAR_TO 0x4E}12BP");
const u8 gText_SoftboiledFree[] = _("SOFTBOILED{CLEAR_TO 0x4E}FREE");
const u8 gText_SeismicTossFree[] = _("SEISMIC TOSS{CLEAR_TO 0x4E}FREE");
const u8 gText_DreamEaterFree[] = _("DREAM EATER{CLEAR_TO 0x4E}FREE");
const u8 gText_MegaPunchFree[] = _("MEGA PUNCH{CLEAR_TO 0x4E}FREE");
const u8 gText_MegaKickFree[] = _("MEGA KICK{CLEAR_TO 0x4E}FREE");
const u8 gText_BodySlamFree[] = _("BODY SLAM{CLEAR_TO 0x4E}FREE");
const u8 gText_RockSlideFree[] = _("ROCK SLIDE{CLEAR_TO 0x4E}FREE");
const u8 gText_CounterFree[] = _("COUNTER{CLEAR_TO 0x4E}FREE");
const u8 gText_ThunderWaveFree[] = _("THUNDER WAVE{CLEAR_TO 0x4E}FREE");
const u8 gText_SwordsDanceFree[] = _("SWORDS DANCE{CLEAR_TO 0x4E}FREE");
const u8 gText_DefenseCurlFree[] = _("DEFENSE CURL{CLEAR_TO 0x4E}FREE");
const u8 gText_SnoreFree[] = _("SNORE{CLEAR_TO 0x4E}FREE");
const u8 gText_MudSlapFree[] = _("MUD-SLAP{CLEAR_TO 0x4E}FREE");
const u8 gText_SwiftFree[] = _("SWIFT{CLEAR_TO 0x4E}FREE");
const u8 gText_IcyWindFree[] = _("ICY WIND{CLEAR_TO 0x4E}FREE");
const u8 gText_EndureFree[] = _("ENDURE{CLEAR_TO 0x4E}FREE");
const u8 gText_PsychUpFree[] = _("PSYCH UP{CLEAR_TO 0x4E}FREE");
const u8 gText_IcePunchFree[] = _("ICE PUNCH{CLEAR_TO 0x4E}FREE");
const u8 gText_ThunderPunchFree[] = _("THUNDERPUNCH{CLEAR_TO 0x4E}FREE");
const u8 gText_FirePunchFree[] = _("FIRE PUNCH{CLEAR_TO 0x4E}FREE");
...
const u8 gText_SurfOverworld[] = _("SURF SPRITE");
const u8 gText_ItemAnimate[] = _("ITEM ANIMATION");
...
const u8 gText_SurfOverworldDynamic[] = _("POKéMON");
const u8 gText_SurfOverworldOriginal[] = _("ORIGINAL");
const u8 gText_ItemAnimateNormal[] = _("NORM");
const u8 gText_ItemAnimateReduced[] = _("LESS");
const u8 gText_ItemAnimateMinimal[] = _("MIN");
const u8 gText_ItemAnimateNone[] = _("NONE");
