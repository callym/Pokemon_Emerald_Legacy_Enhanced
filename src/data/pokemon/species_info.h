...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    [SPECIES_FEEBAS] =
    {
        ...
        .evYield_SpDefense = 0,
        .itemCommon = ITEM_NONE,
        .itemRare   = ITEM_BLUE_SHARD, // Moved Blue Shard to Feebas held item due to changing Clamperl held items to Deepsea items instead
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_ERRATIC,
    ...
    [SPECIES_CLAMPERL] =
    {
        ...
        .evYield_SpAttack  = 0,
        .evYield_SpDefense = 0,
        .itemCommon = ITEM_DEEP_SEA_SCALE, // Clamperl set to have equal chance of either Deepseascale or Deepseatooth held item, see pokemon.c > SetWildMonHeldItem
        .itemRare   = ITEM_DEEP_SEA_TOOTH, // Clamperl set to have equal chance of either Deepseascale or Deepseatooth held item, see pokemon.c > SetWildMonHeldItem
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_ERRATIC,
